import{_ as e,e as n,f as a,o as i}from"./app-C_GFNtNj.js";const l={};function p(t,s){return i(),n("div",null,s[0]||(s[0]=[a(`<h2 id="keepalived-配置文件" tabindex="-1"><a class="header-anchor" href="#keepalived-配置文件"><span>keepalived 配置文件</span></a></h2><div class="language- line-numbers-mode" data-ext="" data-title=""><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span>! /etc/keepalived/keepalived.conf</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>curl -sfk --max-time 2 https://localhost:\${APISERVER_DEST_PORT}/healthz -o /dev/null || errorExit &quot;Error GET https://localhost:\${APISERVER_DEST_PORT}/healthz&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>\${APISERVER_DEST_PORT}</code>使用 Kubernetes 与 API 服务器通信的端口填写占位符，这是 haproxy 或您的负载均衡器将监听的端口。</li></ul>`,7)]))}const d=e(l,[["render",p],["__file","index.html.vue"]]),r=JSON.parse('{"path":"/haconf/","title":"k8s高可用配置","lang":"zh-CN","frontmatter":{"title":"k8s高可用配置","permalink":"/haconf/","createTime":"2025/03/14 13:37:44","description":"keepalived 配置文件 有一些bash变量样式的占位符需要填写： ${STATE}一个MASTER和其他所有主机BACKUP，因此虚拟 IP 最初将分配给MASTER； ${INTERFACE}是参与虚拟 IP 协商的网络接口，例如eth0； ${ROUTER_ID}在同一子网中的所有集群之间应是唯一的，同时在同一个Keepalived集群的所...","head":[["meta",{"property":"og:url","content":"http://git.x-cli.net/haconf/"}],["meta",{"property":"og:site_name","content":"谈呀"}],["meta",{"property":"og:title","content":"k8s高可用配置"}],["meta",{"property":"og:description","content":"keepalived 配置文件 有一些bash变量样式的占位符需要填写： ${STATE}一个MASTER和其他所有主机BACKUP，因此虚拟 IP 最初将分配给MASTER； ${INTERFACE}是参与虚拟 IP 协商的网络接口，例如eth0； ${ROUTER_ID}在同一子网中的所有集群之间应是唯一的，同时在同一个Keepalived集群的所..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-03-14T13:11:38.000Z"}],["meta",{"property":"article:modified_time","content":"2025-03-14T13:11:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"k8s高可用配置\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-03-14T13:11:38.000Z\\",\\"author\\":[]}"]]},"headers":[],"readingTime":{"minutes":1.01,"words":302},"git":{"updatedTime":1741957898000,"contributors":[{"name":"yu","username":"yu","email":"90786339+wyutan@users.noreply.github.com","commits":5,"avatar":"https://avatars.githubusercontent.com/yu?v=4","url":"https://github.com/yu"}]},"autoDesc":true,"filePathRelative":"容器/k8s/note/1.k8s高可用配置.md","categoryList":[{"id":"22c799","sort":10004,"name":"容器"},{"id":"eb26bc","sort":10010,"name":"k8s"},{"id":"74a94d","sort":10011,"name":"note"}]}');export{d as comp,r as data};
