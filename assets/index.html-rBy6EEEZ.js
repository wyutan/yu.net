import{_ as e,e as n,f as a,o as i}from"./app-CS9-o22d.js";const l={};function p(t,s){return i(),n("div",null,s[0]||(s[0]=[a(`<h2 id="keepalived-配置文件" tabindex="-1"><a class="header-anchor" href="#keepalived-配置文件"><span>keepalived 配置文件</span></a></h2><div class="language- line-numbers-mode" data-ext="" data-title=""><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span>! /etc/keepalived/keepalived.conf</span></span>
